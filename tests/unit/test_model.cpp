// Isolated tests for reame::LlamaModel and ModelParams::from_config.
...
using reame::Config;
using reame::LlamaModel;
using reame::ModelError;
using reame::ModelParams;
using reame::TokenId;
...
// Model path: $REAME_TEST_MODEL or models/tinyllama-1.1b-chat-v1.0.Q4_K_M.gguf
...
TEST_CASE("[integration] multi-sequence decode matches sequential decodes",
    ...
    auto ref = reame::make_llama_backend(p);
    ...
    auto pp = p;
    pp.n_seq_max = 2;
    auto multi = reame::make_llama_backend(pp);
